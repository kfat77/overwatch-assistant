<p align="center">
  <img src="https://raw.githubusercontent.com/kfat77/overwatch-assistant/main/assets/icon.png" width="100" alt="Overwatch Assistant" onerror="this.style.display='none'">
</p>

<h1 align="center">守望先锋聊天翻译助手 Overwatch Assistant v2.1</h1>

<p align="center">
  <b>屏幕截图 + OCR + 透明叠加层 · 零注入 · 零封号风险</b>
</p>

<p align="center">
  <a href="https://github.com/kfat77/overwatch-assistant/stargazers">
    <img src="https://img.shields.io/github/stars/kfat77/overwatch-assistant?style=flat-square&color=gold" alt="Stars">
  </a>
  <a href="https://github.com/kfat77/overwatch-assistant/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/kfat77/overwatch-assistant?style=flat-square&color=blue" alt="License">
  </a>
...
> 🔒 **安全声明（必读）**
>
> 本工具**仅读取屏幕像素，不注入游戏进程，不使用 DLL 注入，不修改任何游戏文件或内存**。所有功能通过 Windows 标准 API（屏幕截图 + 透明叠加层）实现，**完全遵守暴雪最终用户许可协议 (EULA)**。
>
> **功能边界**：本工具仅提供游戏内聊天消息的 OCR 识别、翻译和显示，不涉及任何自动化操作、作弊或 unfair advantage。

---

## 🎯 一句话描述

一个为《守望先锋》设计的**聊天翻译工具**，通过屏幕截图+OCR识别游戏内聊天消息，实时翻译为中文并显示在透明叠加层上，帮助玩家跨越语言障碍与全球队友沟通。
...
| 阶段 | 功能 | 状态 |
|:---:|:---|:---:|
| ✅ v1.0 | 实时聊天翻译 + 英雄推荐 | 已完成 |
| ✅ v2.0 | 智能捕获（像素差分 + Timeline对齐 + 多帧共识） | 已完成 |
| ✅ v2.1 | OW 聊天代码 + 预设模板 + 回话功能 | 已完成 |
| 🔄 v2.2 | 更多语言支持（日/俄/西） | 计划中 |
| ⏳ v3.0 | 语音播报翻译结果（TTS） | 计划中 |
| ⏳ v3.5 | 跨游戏支持（Valorant、Apex 等） | 计划中 |
...
> **本工具仅供学习交流使用。请严格遵守暴雪最终用户许可协议 (EULA) 及《守望先锋》游戏规则。**
>
> 本工具：
> - ❌ **不读取游戏内存**
> - ❌ **不使用任何注入技术**
> - ❌ **不执行任何自动化游戏操作**
> - ❌ **不提供任何 unfair advantage**
> - ✅ **仅截取屏幕画面并通过 OCR 识别文字**
> - ✅ **仅提供翻译和显示功能**
>
> **开发者不对因使用本工具导致的任何账号问题负责。** 使用本工具即表示您已阅读并理解上述声明。如有疑虑，请勿使用。
